...
var app = (function () {
	...
	*/
	...
	function create_fragment$1(ctx) {
		var div4, div2, div0, h1, t0, t1, h5, t2, t3, div1, button0, t5, button1, div2_transition, t7, div3, div3_transition, current;
		...
		return {
			c: function create() {
				...
				add_location(h1, file$1, 45, 16, 1272);
				h5.id = "subtitle";
				add_location(h5, file$1, 46, 16, 1316);
				div0.className = "column";
				add_location(div0, file$1, 44, 12, 1235);
				button0.className = "svelte-15yiszt";
				add_location(button0, file$1, 49, 16, 1431);
				button1.className = "svelte-15yiszt";
				add_location(button1, file$1, 50, 16, 1469);
				div1.id = "buttons";
				div1.className = "column svelte-15yiszt";
				add_location(div1, file$1, 48, 12, 1381);
				div2.id = "left";
				div2.className = "column column-60 svelte-15yiszt";
				add_location(div2, file$1, 43, 8, 1165);
				div3.id = "icon";
				set_style(div3, "background-image", "url('" + ctx.img + "')");
				div3.className = "column column-40 svelte-15yiszt";
				add_location(div3, file$1, 53, 8, 1538);
				div4.id = "card";
				div4.className = "row svelte-15yiszt";
				add_location(div4, file$1, 42, 4, 1129);
			},
	...
	function create_fragment$2(ctx) {
		...
		return {
			c: function create() {
				...
				add_location(h2, file$2, 27, 8, 597);
				add_location(h5, file$2, 28, 8, 653);
				div0.className = "column column-50";
				add_location(div0, file$2, 26, 4, 558);
				h1.className = "svelte-nrkto6";
				add_location(h1, file$2, 31, 8, 755);
				div1.className = "column column-50";
				set_style(div1, "text-align", "right");
				add_location(div1, file$2, 30, 4, 690);
				div2.id = "card";
				div2.className = "row svelte-nrkto6";
				add_location(div2, file$2, 25, 0, 508);
			},
	...
	function create_if_block_1(ctx) {
		...
		return {
			c: function create() {
				...
				add_location(h3, file$3, 71, 3, 1557);
			},
	...
	function create_if_block(ctx) {
		...
		return {
			c: function create() {
				h5 = element("h5");
				t = text(ctx.err);
				add_location(h5, file$3, 69, 3, 1509);
			},
	...
	function create_fragment$3(ctx) {
		...
		return {
			c: function create() {
				...
				add_location(h1, file$3, 64, 1, 1362);
				add_location(div0, file$3, 67, 1, 1481);
				add_location(br, file$3, 76, 1, 1707);
				div1.className = "container";
				attr(div1, "align", "center");
				add_location(div1, file$3, 63, 0, 1322);
			},
