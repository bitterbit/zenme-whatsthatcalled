...
var app = (function () {
	...
	*/
	 ...
	 * @namespace WikiPage
	 */
	function wikiPage(title, apiOptions=defaultOptions) {
	    const raw = {};
	    raw.title = title;
	...
	var Mandarin = createCommonjsModule(function (module, exports) {
	let code = {
	...
	var make = createCommonjsModule(function (module, exports) {
	...
	var phoneticize = createCommonjsModule(function (module, exports) {
	var notation = {
	    1: "āēīōū"
	  , 2: "áéíóú"
	  , 3: "ǎěǐǒǔ"
	...
	translate.letter = function(){
	  ...
	  make$1 = make;
	  return callback ? callback.call(this, null, make$1(chinese, Mandarin, separator)) :
	    make$1(chinese, Mandarin, separator);
	};
	...
	translate.pinyin = function(chinese){
	  ...
	  hanzi.forEach(function(word){
	    var key = escape(word).slice(2)
	      , pinyin = Mandarin[key].split(/\s+/);
	      words[words.indexOf(word)] = phoneticize$1(pinyin);
	  });
	...
	var han = createCommonjsModule(function (module, exports) {
	module.exports = exports = {
	    letter: translate_1.letter
	  , pinyin: translate_1.pinyin
	};
	});

	var han$1 = han.pinyin;

	async function getEntry(engTitle) {
	    let page, lang;
	    try {
	    ...
	    const pinyin = han$1(lang.title).map(ch => ch[0]).join(" ");
	...
	function create_fragment(ctx) {
		...
		return {
			c: function create() {
				...
				input.className = input_class_value = "" + (ctx.hasDefault? 'default_value' : '') + " svelte-36f43i";
				attr(input, "type", "text");
				add_location(input, file, 31, 4, 630);
				set_style(div, "text-align", "center");
				add_location(div, file, 30, 0, 593);
			...
			p: function update(changed, ctx) {
				...
				if ((changed.hasDefault) && input_class_value !== (input_class_value = "" + (ctx.hasDefault? 'default_value' : '') + " svelte-36f43i")) {
	...
	*/
	...
	function create_fragment$1(ctx) {
		var div4, div2, div0, h1, t0, t1, h5, t2, t3, div1, a0, t4, a0_class_value, t5, a1, t6, a1_class_value, div2_transition, t7, div3, div3_transition, div4_resize_listener, current;
		...
		return {
			c: function create() {
				...
				div3 = element("div");
				h1.id = "title";
				h1.className = "svelte-1xvnru4";
				add_location(h1, file$1, 79, 16, 2029);
				h5.id = "subtitle";
				add_location(h5, file$1, 80, 16, 2073);
				div0.className = "column";
				add_location(div0, file$1, 78, 12, 1992);
				a0.href = "#abc";
				a0.className = a0_class_value = "" + (ctx.screen.width > 600 ? 'button big-button':'small-button') + " svelte-1xvnru4";
				add_location(a0, file$1, 83, 16, 2188);
				a1.href = "#abc";
				a1.className = a1_class_value = "" + (ctx.screen.width > 600 ? 'button big-button':'small-button') + " svelte-1xvnru4";
				add_location(a1, file$1, 84, 16, 2294);
				div1.id = "buttons";
				div1.className = "column svelte-1xvnru4";
				add_location(div1, file$1, 82, 12, 2138);
				div2.id = "left";
				div2.className = "column column-60 svelte-1xvnru4";
				add_location(div2, file$1, 77, 8, 1922);
				div3.id = "icon";
				set_style(div3, "height", "" + ctx.cardHeight + "+px");
				set_style(div3, "background-image", "url('" + ctx.img + "')");
				div3.className = "column column-40 svelte-1xvnru4";
				add_location(div3, file$1, 87, 8, 2431);
				add_render_callback(() => ctx.div4_resize_handler.call(div4));
				div4.id = "card";
				div4.className = "row svelte-1xvnru4";
				add_location(div4, file$1, 76, 4, 1856);
			},
	...
	function instance$1($$self, $$props, $$invalidate) {
		...
		function div4_resize_handler() {
			cardHeight = this.clientWidth;
			$$invalidate('cardHeight', cardHeight);
		}
	...
	function create_fragment$2(ctx) {
		var div2, div0, h2, t0, t1, h5, t2, t3, div1, h1, t4, div2_intro, div2_outro, current;
		...
		return {
			c: function create() {
				...
				div1 = element("div");
				h1 = element("h1");
				t4 = text(ctx.engTitle);
				set_style(h2, "margin-bottom", "-5px");
				h2.className = "svelte-1x643c6";
				add_location(h2, file$2, 47, 8, 970);
				h5.className = "svelte-1x643c6";
				add_location(h5, file$2, 48, 8, 1026);
				div0.className = "column column-50";
				add_location(div0, file$2, 46, 4, 931);
				h1.className = "svelte-1x643c6";
				add_location(h1, file$2, 51, 8, 1139);
				div1.id = "right";
				div1.className = "column column-50 svelte-1x643c6";
				set_style(div1, "text-align", "right");
				add_location(div1, file$2, 50, 4, 1063);
				div2.id = "card";
				div2.className = "row svelte-1x643c6";
				add_location(div2, file$2, 45, 0, 881);
			},
			...
			p: function update(changed, ctx) {
				if (!current || changed.zhTitle) {
					set_data(t0, ctx.zhTitle);
				}

				if (!current || changed.zhSubtitle) {
					set_data(t2, ctx.zhSubtitle);
				}

				if (!current || changed.engTitle) {
					set_data(t4, ctx.engTitle);
				}
			},
			...
			i: function intro(local) {
				...
				add_render_callback(() => {
					...
					if (!div2_intro) div2_intro = create_in_transition(div2, slide, {});
					div2_intro.start();
				});
	...
	function create_else_block(ctx) {
		...
		var resultcard = new Resultcard({
			props: {
			title: ctx.prevEntry.title,
			subtitle: ctx.prevEntry.subtitle,
			img: ctx.prevEntry.img
		},
			$$inline: true
		});
		...
		return {
			...
			p: function update(changed, ctx) {
				...
				if (changed.prevEntry) resultcard_changes.title = ctx.prevEntry.title;
				if (changed.prevEntry) resultcard_changes.subtitle = ctx.prevEntry.subtitle;
				if (changed.prevEntry) resultcard_changes.img = ctx.prevEntry.img;
	...
	function create_if_block_1(ctx) {
		...
		return {
			c: function create() {
				h3 = element("h3");
				h3.textContent = "Type to find out...";
				add_location(h3, file$3, 75, 3, 1601);
			},
	...
	function create_if_block(ctx) {
		...
		return {
			c: function create() {
				h5 = element("h5");
				t = text(ctx.err);
				add_location(h5, file$3, 73, 3, 1553);
			},
	...
	// (83:1) {#each history as entry}
	function create_each_block(ctx) {
		var current;

		var historycard = new Historycard({
			props: {
			engTitle: ctx.entry.origin,
			zhTitle: ctx.entry.title,
			zhSubtitle: ctx.entry.subtitle
		},
			$$inline: true
		});
		...
		return {
			...
			p: function update(changed, ctx) {
				var historycard_changes = {};
				if (changed.history) historycard_changes.engTitle = ctx.entry.origin;
				if (changed.history) historycard_changes.zhTitle = ctx.entry.title;
				if (changed.history) historycard_changes.zhSubtitle = ctx.entry.subtitle;
			...
			d: function destroy(detaching) {
				historycard.$destroy(detaching);
			}
		};
	}

	function create_fragment$3(ctx) {
		var div1, h1, t1, updating_value, t2, div0, current_block_type_index, if_block, t3, br, t4, current;
		...
		function select_block_type(ctx) {
			...
			if (!ctx.loadedFirstItem) return 1;
			return 2;
		}
		...
		return {
			c: function create() {
				...
				add_location(h1, file$3, 68, 1, 1406);
				add_location(div0, file$3, 71, 1, 1525);
				add_location(br, file$3, 80, 1, 1751);
				div1.className = "container";
				attr(div1, "align", "center");
				add_location(div1, file$3, 67, 0, 1366);
			},
	...
	function instance$3($$self, $$props, $$invalidate) {
		...
		function addToHistory(entry){
			$$invalidate('history', history = [entry, ...history]);
		}
		...
		function removeFromHistory(entry){
			...
			if (index >= 0) {
				setTimeout(() => {
					$$invalidate('history', history = history.filter(h => h.title !== entry.title));
				}, 50);
			}
		}
		...
		function onTranslateChange() {
			...
			$$invalidate('wikiPromise', wikiPromise = getEntry(toTranslate));
			wikiPromise.then((entry) => {
				$$invalidate('err', err = undefined);
				if (loadedFirstItem) {
					addToHistory(prevEntry);
					removeFromHistory(entry);
				}
				$$invalidate('prevEntry', prevEntry = entry); 
				$$invalidate('loadedFirstItem', loadedFirstItem = true);
			}).catch(e => {
				if(prevEntry !== undefined && entryInHistory(prevEntry) == -1){
					addToHistory(prevEntry);
					console.log("added entry after error", prevEntry);
				}
				$$invalidate('err', err = e);
			});
		}
